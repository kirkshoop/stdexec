    ...
    template <class _CPO, class _V, class _B>
      struct __sender {
          ...
          struct __operation : __immovable {
            ...
            struct __value_receiver {
                ...
                friend void tag_invoke(set_value_t, __value_receiver&& __value_rcvr, _Args&&...) noexcept try {
                    ...
                    auto __adapted_value{execution::P0TBD::set_next(__op_state->__rcvr_, __value_sender<_CPO, _V>{__op_state->__next_++})};
                    __value_op.emplace(
                        __conv{
                            [&](){
            ...
            using __value_sender_t=invoke_result_t<execution::P0TBD::set_next_t, _SequenceReceiver&, __value_sender<_CPO, _V>>;
        ...
        template <class _SequenceReceiver>
          requires copy_constructible<_V> && copy_constructible<_B>
        friend auto tag_invoke(connect_t, const __sender& __sndr, _SequenceReceiver&& __rcvr)
          ...
          return {{}, (_SequenceReceiver&&) __rcvr, ((__sender&&) __sndr).__value_, ((__sender&&) __sndr).__bound_};
        }

        template <class _SequenceReceiver>
        friend auto tag_invoke(connect_t, __sender&& __sndr, _SequenceReceiver&& __rcvr)
          noexcept(is_nothrow_move_constructible_v<_V> && is_nothrow_move_constructible_v<_B>)
          -> __operation<__x<remove_cvref_t<_SequenceReceiver>>> {
          return {{}, (_SequenceReceiver&&) __rcvr, ((__sender&&) __sndr).__value_, ((__sender&&) __sndr).__bound_};
        }
      };
    ...
    template <class _SequenceSenderId>
      ...
      template <class _Receiver>
        ...
        template <__decays_to<__sequence_sender> _Self, receiver _Receiver>
          requires sender_to<__member_t<_Self, _SequenceSender>, __sequence_receiver<_Receiver>>
        friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr)
          noexcept(__has_nothrow_connect<__member_t<_Self, _SequenceSender>, __sequence_receiver<_Receiver>>)
          //recursive template instantiation
          {//-> connect_result_t<__member_t<_Self, _SequenceSender>, __sequence_receiver<_Receiver>> {
    ...
    template <class _SequenceSenderId, class _FunId>
      struct __sequence_sender {
        ...
        template <__decays_to<__sequence_sender> _Self, receiver _SequenceReceiver>
          requires sender_to<__member_t<_Self, _SequenceSender>, __sequence_receiver_t<_SequenceReceiver>>
        friend auto tag_invoke(connect_t, _Self&& __self, _SequenceReceiver&& __rcvr)
          noexcept(__has_nothrow_connect<__member_t<_Self, _SequenceSender>, __sequence_receiver_t<_SequenceReceiver>>)
          // recursive template instantiation
          {//-> connect_result_t<__member_t<_Self, _SequenceSender>, __sequence_receiver_t<_SequenceReceiver>> {
          return connect(
