...
stdenv.mkDerivation {
  ...
  packages = [
    ...
    ++ lib.optional (enableDocuments) doxygen
    ++ lib.optional (enableDocuments) sphinx
    ++ lib.optional (enableTBB) tbb
    ++ lib.optional (enableIoUring) liburing
  ;
  ...
  nativeBuildInputs = [ cmake extra-cmake-modules cpm-cmake ninja ];
  buildInputs = [ ]
    ++ lib.optional (enableTBB) tbb
    ++ lib.optional (enableIoUring) liburing
  ;
